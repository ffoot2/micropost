    ...
    <div class="row">
        ...
        <div class="col-xs-8">
            <ul class="nav nav-tabs nav-justified">
                ...
                <li role="presentation" class="{{ Request::is('users/*/favorittings') ? 'active' : '' }}"><a href="{{ route('favorites.favorittings', ['id' => $user->id]) }}">お気に入り <span class="badge">{{ $count_favorittings }}</span></a></li>
            </ul>
